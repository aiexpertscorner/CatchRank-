            ...
            {step === 'upload' ? (
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 text-center space-y-2 px-6">
                    <p className="text-xl sm:text-2xl font-black text-primary tracking-tight">Maak of kies een foto</p>
                    <p className="text-xs sm:text-sm text-text-muted font-medium">"Een foto zegt meer dan duizend woorden, vriend!"</p>
                  </div>
                  <input 
                    type="file" 
                    ref={fileInputRef} 
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-6">
                  <div className="p-4 sm:p-6 bg-surface-soft/50 rounded-[1.25rem] sm:rounded-[1.5rem] border border-border-subtle flex items-center gap-3 sm:gap-4 group hover:border-water/30 transition-colors">
                    ...
                    <div className="min-w-0">
                      <p className="text-[8px] sm:text-[10px] font-black text-text-muted uppercase tracking-widest mb-0.5 sm:mb-1">Locatie</p>
                      <p className="text-[10px] sm:text-xs font-bold text-primary truncate">Huidige positie</p>
                    </div>
                  </div>
                  <div className="p-4 sm:p-6 bg-surface-soft/50 rounded-[1.25rem] sm:rounded-[1.5rem] border border-border-subtle flex items-center gap-3 sm:gap-4 group hover:border-accent/30 transition-colors">
                    ...
                    <div className="min-w-0">
                      <p className="text-[8px] sm:text-[10px] font-black text-text-muted uppercase tracking-widest mb-0.5 sm:mb-1">Beloning</p>
                      <p className="text-[10px] sm:text-xs font-bold text-primary truncate">+10 XP Basis</p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="aspect-square w-full rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden border border-border-subtle shadow-premium bg-surface-soft relative group">
                  ...
                  <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 right-6 sm:right-8 text-white opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start gap-4 sm:gap-5 p-6 sm:p-8 bg-warning/5 border border-warning/10 rounded-[1.5rem] sm:rounded-[2rem]">
                    ...
                    <div className="space-y-0.5 sm:space-y-1">
                      <p className="text-xs sm:text-sm font-black text-primary uppercase tracking-tight">Concept Opslag</p>
                  ...
                  <div className="flex items-center justify-between p-6 sm:p-8 bg-surface-soft/50 rounded-[1.5rem] sm:rounded-[2rem] border border-border-subtle">
                    <div className="flex items-center gap-4 sm:gap-5">
                      ...
                      <div>
                        <p className="text-base sm:text-lg font-black text-primary tracking-tight">Vangst Loggen</p>
                        <p className="text-[8px] sm:text-[10px] font-black text-text-muted uppercase tracking-widest">Klaar voor verwerking</p>
                      </div>
                    </div>
                    <Badge variant="success" className="px-4 sm:px-5 py-1.5 sm:py-2 rounded-xl text-[8px] sm:text-[10px] font-black uppercase tracking-widest shadow-sm">Gereed</Badge>
                  </div>
                </div>
              </motion.div>
            )}
